# -*- encoding: utf-8 -*-
# stub: stockpile-redis 1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_stockpile_adapter_redis.rb", "test/test_stockpile_redis.rb"]

  if s.respond_to? :specification_version then
    s.specification_version = 4

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<stockpile>, ["~> 1.0"])
      ...
      s.add_dependency(%q<stockpile>, ["~> 1.0"])
